...
class Seq2SeqDataset(Dataset):
    def __init__(self, examples: List[Dict[str, Any]], tokenizer: T5Tokenizer, max_source_length: int, max_target_length: int):
    ...
    def __getitem__(self, idx: int) -> Dict[str, torch.Tensor]:
        ...
        src = self.tokenizer(
            source, max_length=self.max_source_length, padding="max_length", truncation=True, return_tensors="pt"
        )
        tgt = self.tokenizer(
...
def main() -> None:
    ...
    ap.add_argument("--model_name", type=str, default="t5-base")
    ap.add_argument("--output_dir", type=str, default="outputs/t5_base")
